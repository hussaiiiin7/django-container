...
curl https://raw.githubusercontent.com/srivardhanrr/django-auto-container/main/.github/workflows/build-container.yaml > .github/workflows/build-container.yaml
```
...
value = "gunicorn srhome.wsgi:application --bind \"0.0.0.0:$PORT\""
```
